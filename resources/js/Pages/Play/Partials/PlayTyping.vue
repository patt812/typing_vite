...
const unfinishedRoma = computed(() => typing.value.sentence.displayRoma
  .slice(typing.value.statistics.correct));
  ...
  <div>
    ...
    <div v-if="typing.isStarted && !typing.isFinished">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full flex flex-wrap gap-8 ">
            <div class="flex items-center flex-wrap">
              ...
              <TypingAccuracy
                class="ml-4"
                :accuracy="typing.statistics
                  .calcAccuracy(typing.statistics.correct,typing.statistics.mistake)"
              />
            </div>
            <div class="flex items-center flex-wrap">
              <SpeedMeter class="mb-3" :angle="typing.statistics.getTotalWPM()" />
              <TypingAccuracy
                class="ml-4" :accuracy="typing.statistics
                  .calcAccuracy(typing.statistics.totalCorrect, typing.statistics.totalMistake)"
              />
            </div>
          </div>
        </div>
      ...
      <div class="sm:hidden md:mt-32">
        <div class="mt-3 mb-3">
          ...
          <div>
            現在成功率：{{ typing.statistics.calcAccuracy(typing.statistics.correct,
                                                    typing.statistics.mistake) }}%
          </div>
          <div>合計WPM：{{ typing.statistics.totalWPM }}</div>
          <div>
            合計成功率：{{ typing.statistics.calcAccuracy(typing.statistics.totalCorrect,
    ...
    <div v-if="!typing.isStarted && typing.isFinished">
      ...
      <div class="scroll-bar max-h-60 overflow-auto">
        <div
          v-for="i of typing.sentence.ids.length" :key="i"
      ...
      <div class="flex justify-center mt-3">
        <SecondaryButton @click="getSentence(0)">
          もう一度
        </SecondaryButton>
      </div>
    </div>
