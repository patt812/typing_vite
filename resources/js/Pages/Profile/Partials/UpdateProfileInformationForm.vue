    ...
    <form @submit.prevent="updateProfileInformation">
      ...
      <div class="mt-2 mb-6">
        ...
        <TextInput
          ...
          class="mt-1 block w-full max-w-xl" autocomplete="name"
      ...
      <div class="mb-7">
        ...
        <TextInput
          ...
          type="email" class="mt-1 block w-full max-w-xl"
        />
        <InputError :message="form.errors.email" class="mt-2" />
      </div>

      <PrimaryButton
        type="submit" class="mx-auto px-10" :class="{ 'opacity-25': form.processing }"
