        ...
        <form @submit.prevent="store">
          ...
          <div class="flex items-center mt-2">
            ...
            <TextInput
              ...
              type="number"
              class="ml-2 w-full max-w-[12.8rem]"
              min="1"
              max="1000"
              required
            />
          ...
          <div class="flex mt-1 items-center">
            <RadioInput
              id="prior-every"
              v-model:checked="form.prior_no_stats"
              type="radio"
              name="prior-type"
              value="0"
            />
