  ...
  <div>
    <div>
      <div v-if="isPreference" class="flex mt-1 items-center align-middle">
        ...
        <RadioInput
          id="list-type-on" v-model:checked="radioDiv" type="radio" class="ml-3" name="list-type"
          value="1"
        />
        <InputLabel class="ml-1 pt-0.5" for="list-type-on" value="出題する" />

        <RadioInput
          id="list-type-off" v-model:checked="radioDiv" type="radio" class="ml-3" name="list-type"
          value="2"
        />
      ...
      <div class="flex w-full mt-3">
        ...
        <TextInput
          id="sentence-search" ref="searchBox"
          v-model="searchWord" class="ml-2 w-full max-w-md"
        />
      </div>
    </div>
    ...
    <div class="w-full mt-2">
      <div class="flex items-center justify-between border-black border-b-2 font-bold">
        ...
        <div v-if="showIfSelected" class="w-1/12 px-2 py-1">
          出題
        </div>
        <div class="w-5/12 px-2 py-1">
          文章
        </div>
        <div class="w-5/12 px-2 py-1">
          かな
