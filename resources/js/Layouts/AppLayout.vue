    ...
    <div class="min-h-screen bg-main pb-10">
      <nav class="sticky top-0 z-50 w-full">
                    ...
                    <template #trigger>
                      <span class="inline-flex rounded-md">
                        <button
                          ...
                          bg-white hover:bg-gray-50 hover:text-gray-700 focus:outline-none
                  ...
                  <span class="inline-flex rounded-md">
                    ...
                    <form @submit.prevent="logout">
                      <button
                        ...
                        border-transparent text-sm leading-4 font-medium hover:text-gray-700"
                      >
                        →
                      </button>
                    </form>
        ...
        <div
          ...
          class="flush bg-main font-bold absolute z-2 w-full text-center
          border-l-4 border-r-4 border-b-4 border-black rounded-b-md"
